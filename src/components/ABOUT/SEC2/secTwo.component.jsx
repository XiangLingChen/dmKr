    ...
    <div className='secTwo-container'>
        <div className='secTwo-col1'>
            ...
            <div className='secTwo-text1'>
                <h1 className='secTwo-title'>WE CARE ABOUT YOU</h1>
                <p className='secTwo-text1-content1'>We dedicate to innovating formulas that works for different needs.</p>
                <p className='secTwo-text1-content2'>From dryness to oily skin, we have the right treatment for you!</p>
        ...
        <div className='secTwo-col2'>
            <div className='secTwo-text2'>
                ...
                <p className='secTwo-text2-content'>Discover healthy-looking skin with formulas powered by nature and science with us.</p>
            </div>
